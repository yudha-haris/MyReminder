package com.example.myreminder.reminder.data
...
import com.example.myreminder.core.data.ApiResponse
...
import com.example.myreminder.reminder.utils.ReminderMapper
...
class Repository(
    ...
    override fun getAllReminder(): Flow<Resource<List<Reminder>>> =
        object :
            com.example.myreminder.core.data.NetworkBoundResource<List<Reminder>, List<TodosItem>>() {
